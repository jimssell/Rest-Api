...
class Refinance_form_Table extends WP_List_Table {
	...
	function __construct(){
		global $status, $page;
			parent::__construct( array(
				'singular'  => "Reverse Mortgage Form",
				'plural'    => "Reverse Mortgage Form",
				'ajax'      => false
	...
	function column_id($item){
		...
		$actions = array(
			...
			'view'    => sprintf('<a href="javascript:void(0);" onclick="view_this_reverse_item(%s)">View</a>',$item->id, 'view',$item->id),
	...
	function prepare_items() {
		...
		/* -- Preparing your query -- */
			$query = "SELECT * FROM ".$prefix."reverse_mortgage_form_record where 1=1 ".$where;
...
<div class="wrap">
<h2 id="setting_nav" class="nav-tab-wrapper"> <a class="nav-tab" id="background_setting" href="admin.php?page=mortgage_form">Mortgage Form</a> <a class="nav-tab" href="admin.php?page=refinance_form">Refinance Form</a><span class="nav-tab nav-tab-active">Reverse Mortgage Form</span> <a class="nav-tab" href="admin.php?page=form_setting">Form Setting</a></h2>
<h1></h1>
